    ...
    return (
        <div className="flex flex-col items-center group cursor-default">
            <div className="relative flex items-baseline gap-1 mb-2">
                <span className="text-6xl md:text-8xl font-audiowide font-bold text-transparent bg-clip-text bg-gradient-to-b from-white to-neutral-400 tracking-tighter group-hover:from-fuchsia-400 group-hover:to-fuchsia-700 transition-all duration-500">
                    <Counter value={value} />
                </span>
                {suffix && (
                    <span className="text-2xl md:text-3xl font-rajdhani text-neutral-400 group-hover:text-fuchsia-500/50 transition-colors">
                        {suffix}
                    </span>
                )}
                {(value === 100 || value === 5) && (
