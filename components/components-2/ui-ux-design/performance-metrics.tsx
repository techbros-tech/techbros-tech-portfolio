        ...
        <section className="py-24 bg-black border-t border-neutral-900 relative">
            <div className="container mx-auto px-4">
                <div className="flex flex-wrap items-center justify-center gap-12 md:gap-24">
                    <MetricItem value={100} label="User Satisfaction" suffix="%" />
                    <div className="hidden md:block w-px h-24 bg-gradient-to-b from-transparent via-neutral-800 to-transparent" />
                    <MetricItem value={98} label="Task Completion" suffix="%" />
                    <div className="hidden md:block w-px h-24 bg-gradient-to-b from-transparent via-neutral-800 to-transparent" />
                    <MetricItem value={100} label="Accessibility" suffix="%" />
                    <div className="hidden md:block w-px h-24 bg-gradient-to-b from-transparent via-neutral-800 to-transparent" />
                    <MetricItem value={5} label="Stars Rated" suffix=".0" />
                </div>
            </div>
        </section>
    );
    ...
    return (
        <div className="flex flex-col items-center group cursor-default">
            <div className="relative flex items-baseline gap-1 mb-2">
                <span className="text-6xl md:text-8xl font-audiowide font-bold text-transparent bg-clip-text bg-gradient-to-b from-white to-neutral-700 tracking-tighter group-hover:from-fuchsia-400 group-hover:to-fuchsia-700 transition-all duration-500">
                    <Counter value={value} />
                </span>
                {suffix && (
                    <span className="text-2xl md:text-3xl font-rajdhani text-neutral-600 group-hover:text-fuchsia-500/50 transition-colors">
                        {suffix}
                    </span>
                )}
                {(value === 100 || value === 5) && (
