...
import { Search, PenTool, Target, TrendingUp } from "lucide-react";
...
const steps = [
    {
        id: "01",
        title: "Audit",
        description: "Deep dive into your current brand & market position.",
    ...
    },
    {
        id: "02",
        title: "Define",
        description: "Articulating your core values & unique proposition.",
    ...
    },
    {
        id: "03",
        title: "Execute",
        description: "Bringing the strategy to life through design & content.",
    ...
    },
    {
        id: "04",
        title: "Grow",
        description: "Scaling your brand impact & market reach.",
            ...
            <div className="container mx-auto px-4 relative z-10 max-w-7xl">
                ...
                <div className="text-center mb-20 md:mb-32">
                    ...
                    <p className="text-neutral-400 font-rajdhani text-xl">
                        From market insights to dominant positioning.
                    </p>
                </div>
